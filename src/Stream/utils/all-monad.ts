 ...
 * @__PURE__
 */
export function allM<F extends URIS4>(M: Monad4<F>): <S, R, E>(input: Stream<Kind4<F, S, R, E, boolean>>) => Kind4<F, S, R, E, boolean>
 ...
 * @__PURE__
 */
export function allM<F extends URIS3>(M: Monad3<F>): <R, E>(input: Stream<Kind3<F, R, E, boolean>>) => Kind3<F, R, E, boolean>
 ...
 *  @__PURE__
 */
export function allM<F extends URIS3, E>(M: Monad3C<F, E>): <R>(input: Stream<Kind3<F, R, E, boolean>>) => Kind3<F, R, E, boolean>
 ...
 * @__PURE__
 */
export function allM<F extends URIS2>(M: Monad2<F>): <E>(input: Stream<Kind2<F, E, boolean>>) => Kind2<F, E, boolean>
 ...
 * @__PURE__
 */
export function allM<F extends URIS2, E>(M: Monad2C<F, E>): (input: Stream<Kind2<F, E, boolean>>) => Kind2<F, E, boolean>
 ...
 * @__PURE__
 */
export function allM<F extends URIS>(M: Monad1<F>): (input: Stream<Kind<F, boolean>>) => Kind<F, boolean>
 ...
 * @__PURE__
 */
export function allM<F>(M: Monad<F>) {
  /**
   ...
   * @__PURE__
   */
  return function _allM(input: Stream<HKT<F, boolean>>): HKT<F, boolean> {
    return pipe(
      input,
      reduce(M.of(true), (x, y) => M.chain(x, b => (b ? y : M.of(false))))
    )
  }
}
